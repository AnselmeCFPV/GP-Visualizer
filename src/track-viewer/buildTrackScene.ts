...
import { applyLapmetaProfileLocal } from './utils/lapmetaElevation';
...
export function buildTrackScene(borders: TrackBorders, opts: BuildOptions): TrackSceneData {
  ...
  const outerSmooth = applyLapmetaProfileLocal(
    smoothClosedBorder(outerLocal, {
      chaikinIterations: 2,

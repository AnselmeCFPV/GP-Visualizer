export type { GeoPoint, LocalPoint, TrackBorders } from '@prenois/geo';

import type { LocalPoint, TrackBorders } from '@prenois/geo';

/** Options du monde partagé (scène, pilotes, rendu) */
export interface TrackWorldOptions {
  /** Bordures du circuit (requis) */
  borders: TrackBorders;
  /**
   * Profil d'élévation sur la bordure locale lissée (ex. LapMeta via @prenois/circuit).
   * Si omis, les altitudes proviennent directement des points GPS des bordures.
   */
